...
namespace MarsRover {
    ...
    public class Position : IPosition {
        ...
        public void StartMoving(List<int> maxPoints, string moves)
        {
            ...
            {
                RoverRotateDirection moveType = (RoverRotateDirection)move;
                switch (moveType)
                {
                    case RoverRotateDirection.M:
                        this.MoveInSameDirection();
                        break;
                    case RoverRotateDirection.L:
                        this.Rotate90Left();
                        break;
                    case RoverRotateDirection.R:
                        this.Rotate90Right();
                        break;
                    default:
                ...
                {
                    throw new OutOfBoundaryException(maxPoints[0], maxPoints[1], "Y");
                }
            }
        }
    }
